...
<body>
    ...
    <div class="sidebar-content">
        <ul class="navigation">
            ...
            <li>
                <a href="<?php echo base_url().'admin/testi'?>"><i class="fa fa-file-o"></i> <span>Testi</span></a>
            </li>
        </ul>
    </div>
</div>
              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                       $id_testi=$i['id_testi'];
                       $nama_testi=$i['nama_testi'];
                       $isi_testi=$i['isi_testi'];
                       $foto_testi=$i['foto_testi'];
                       $tanggal=$i['tanggal'];
                       
                    ?>
                <tr>
                  <td><?php echo $tanggal;?></td>
                  <td><?php echo $nama_testi;?></td>
                  <td><?php echo $isi_testi;?></td>
                  <td><img width="40" height="40" class="img-circle" src="<?php echo base_url().'assets/img/testi/'.$foto_testi;?>"></td>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_testi;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                <?php endforeach;?>
                </tbody>
...
<!-- ./wrapper -->
    ...
    <!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $id_testi;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/testi/hapus_testi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                                   <input type="hidden" name="kode" value="<?php echo $id_testi;?>"/> 
